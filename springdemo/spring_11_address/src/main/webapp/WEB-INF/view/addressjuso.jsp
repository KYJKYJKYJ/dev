...
function goPopup(){
	...
	var pop = window.open("/myaddress/popup.do","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="button" id="search" value="우편번호검색" onclick="goPopup();">
					</td>
				</tr>
				
				<tr>
					<td>
						<input type="text" id="roadAddrPart1" name="roadAddrPart1" readonly="readonly"/>
					</td>
				</tr>
